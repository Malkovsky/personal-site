...
```cpp
c = condition ? if_expression : else_expression;
```
or fully branchless variants may sometimes outperform a traditional `if`, but this should be verified with benchmarks rather than treated as a universal rule.
