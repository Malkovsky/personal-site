...
![Sparse table query](images/sparse_table_query.svg){fig-alt="Sparse table rows store arg-min positions for intervals of power-of-two length; a query is answered by comparing two overlapping intervals."}
...
I'm working on succinct data structure library [pixie](https://github.com/Malkovsky/pixie), If I got your interest and you want to collaborate -- feel free to contact me.
